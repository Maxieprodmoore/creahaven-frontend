...
class UserAPI {
  ...
  async getCreatives() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/creative"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
  ...
  async addFavCreative(creativeId) {
    // validate
    if (!creativeId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavCreative"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.displayName == null ? (0, _litHtml.html)(_templateObject4(), this.user.firstName, this.user.lastName) : (0, _litHtml.html)(_templateObject5(), this.user.displayName), this.user.email, this.user.bio, this.user.website, this.user.facebook, this.user.twitter, this.user.instagram, this.user.youtube, this.user.avatar ? (0, _litHtml.html)(_templateObject6(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject7())));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"views/pages/favouriteCreatives.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Favourite Creatives\" user=\"", "\"></va-app-header>\n      <div class=\"page-body\">\n        <div class=\"page-content\">        \n          <h1>Favourite Creatives</h1>\n          <div class=\"haircuts-grid\">\n            ", "\n          </div>\n          \n        </div>\n      </div>\n            \n    "]);
...
class favouriteCreativesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favCreatives == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.favCreatives.map(creative => (0, _litHtml.html)(_templateObject4(), creative._id, creative.displayName, creative.email, creative.avatar, creative.bio, creative.website, creative.facebook, creative.instagram, creative.twitter, creative.youtube))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
var _default = new JobAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/jobs.js":[function(require,module,exports) {
"use strict";
...
var _default = new jobVacanciesView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../JobAPI":"JobAPI.js","../../Toast":"Toast.js"}],"views/pages/creatives.js":[function(require,module,exports) {
"use strict";
...
class CreativesView {
  ...
  async getCreatives() {
    try {
      this.creatives = await _UserAPI.default.getCreatives();
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.clearFilters.bind(this), this.creatives == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.creatives.map(creative => (0, _litHtml.html)(_templateObject4(), creative._id, creative.displayName, creative.email, creative.avatar, creative.bio, creative.website, creative.facebook, creative.instagram, creative.twitter, creative.youtube))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class newPortfolioView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newPortfolioSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../PortfolioAPI":"PortfolioAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _favouriteCreatives = _interopRequireDefault(require("./views/pages/favouriteCreatives"));
...
const routes = {
  '/': _home.default,
  '404': _.default,
  '/favouriteCreatives': _favouriteCreatives.default,
...
customElements.define('va-creative', class Creative extends _litElement.LitElement {
  ...
  async addFavHandler() {
    try {
      await _UserAPI.default.addFavCreative(this.id);

      _Toast.default.show('Creative added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
