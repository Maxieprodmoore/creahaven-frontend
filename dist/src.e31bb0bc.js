...
class CreativesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.creatives == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.creatives.map(creative => (0, _litHtml.html)(_templateObject4(), creative._id, creative.displayName, creative.email, creative.avatar, creative.bio, creative.website, creative.facebook, creative.instagram, creative.twitter, creative.youtube))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
